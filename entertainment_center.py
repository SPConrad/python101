...
toy_story = media.Movie("Toy Story", "Toys do stuff", "https://upload.wikimed" +
                        "ia.org/wikipedia/en/thumb/1/13/Toy_Story.jpg/220px" +
...
serenity = media.Movie("Serenity", "They aim to misbehave", "https://upload.w"
                       + "ikimedia.org/wikipedia/en/thumb/9/9e/Serenity_One_S"
                       + "heet.jpg/215px-Serenity_One_Sheet.jpg", "https://ww"
                       + "w.youtube.com/watch?v=6nEAlpTb4tk")

avengers = media.Movie("Avengers", "They assemble", "https://upload.wikimedia"
                       + ".org/wikipedia/en/thumb/f/f9/TheAvengers2012Poster."
                       + "jpg/220px-TheAvengers2012Poster.jpg", "https://www."
                       + "youtube.com/watch?v=eOrNdBpGMv8")

skyfall = media.Movie("Skyfall", "Bond wins, but also loses", "https://upload"
                      + ".wikimedia.org/wikipedia/en/thumb/a/a7/Skyfall_poste"
                      + "r.jpg/220px-Skyfall_poster.jpg", "https://www.youtub"
                      + "e.com/watch?v=6kw1UVovByw")

the_martian = media.Movie("The Martian", "Matt Damon gets stranded AGAIN", "h"
                          + "ttps://upload.wikimedia.org/wikipedia/en/thumb/c"
